...
Fullstack Application — React (TypeScript) frontend, Axios HTTP client, Spring Boot Java backend, OkHttp client, and MySQL (AWS RDS - MySQL) service. (Template)
...
- [AWS RDS - MySQL](https://aws.amazon.com/rds/aurora/)
