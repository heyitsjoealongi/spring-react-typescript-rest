...
- Docker [build](https://docs.docker.com/engine/reference/commandline/build/) command
  ...
  ```bash
  docker build -t spring-react-typescript-rest/frontend:latest .
  ```
...
- Docker [run](https://docs.docker.com/engine/reference/commandline/run/) command
  ...
  ```bash
  docker run -p 3000:3000 spring-react-typescript-rest/frontend:latest
  ```
...
- Docker [tag](https://docs.docker.com/engine/reference/commandline/tag/) command
  ...
  ```bash
  docker tag spring-react-typescript-rest/frontend collectedview/spring-react-typescript-rest-frontend:latest
  ```
...
- Docker [run](https://docs.docker.com/engine/reference/commandline/run/) command
  ...
  ```bash
  docker run -p 9000:9000 spring-react-typescript-rest/backend:latest
  ```

  Start Container (Interactively & pseudo-TTY) :

  ```bash
  docker run spring-react-typescript-rest/backend:latest -it 9000:9000
  ```
...
- Docker [tag](https://docs.docker.com/engine/reference/commandline/tag/) command
  ...
  ```bash
  docker tag spring-react-typescript-rest/backend collectedview/spring-react-typescript-rest-backend:latest
  ```
...
- Docker [tag](https://docs.docker.com/engine/reference/commandline/tag/) command
  ...
  ```bash
  docker tag spring-react-typescript-rest/backend <aws_account_id>.dkr.ecr.<region>.amazonaws.com/<repository>:latest
  ```
...
- Rollout restart deployment with KubeCTL to pull new image
  ...
  ```bash
  kubectl rollout restart deployment/backend-deployment --namespace=<namespace>
  ```

- Check for successful EKS cluster deployment pod restarts with KubeCTL
